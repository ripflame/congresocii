    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          <h4 class="text-center">¡Felicidades <?php echo "{$participante['nombre']} {$participante['ap_paterno']} {$participante['ap_materno']}"; ?>!, ya est&aacute;s registrado en tu nuevo taller</h4>
      </div>
      <div class="row">
        <div class="col-sm-2 col-sm-offset-5">
          <a href="edicionLoginTalleres.php" class="btn btn-default center-block">Regresar</a>
        </div>
        </div>
      </div>
    </div>
